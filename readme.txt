...
* CHANGE: added debug message for API key 

= 3.3.7 =

* FIX: bug which prevented topics to be taken from taxonomies automatically

= 3.3.6 = 

* FIX: posts published via XMLRPC are now saved to News@me

= 3.3.5 = 

* FIX: minor fix to admin ui 
